...
import { GatedTypeEnum, GatedEntryTypeEnum } from "@/generated/models.gen";
...
const GatedTokenDialog = () => {
  ...
  return (
    <DialogWrapper title="Gated Token" onClose={() => setInputDialog(null)}>
      <div className="flex flex-col items-center justify-center">
        ...
        <Button
          ...
          onClick={() => {
            // Create the entry type enum
            const entryType = new CairoCustomEnum({
              criteria:
              ...
              uniform:
                selectedEntryType === "uniform"
                  ? uniformEntryCount!!
                  : undefined,
            }) as GatedEntryTypeEnum; // Type assertion if needed

            // Create the gated type enum
            const gatedTypeEnum = new CairoCustomEnum({
              ...
              address: undefined,
            }) as GatedTypeEnum; // Type assertion if needed
