...
// Type definition for `tournament::ls15_components::models::loot_survivor::AdventurerMetadataStorage` struct
...
export type InputAdventurerMetadataStorage = RemoveFieldOrder<AdventurerMetadataStorage>;
...
// Type definition for `tournament::ls15_components::models::loot_survivor::FreeGameAvailableModel` struct
...
export type InputFreeGameAvailableModel = RemoveFieldOrder<FreeGameAvailableModel>;

// Type definition for `tournament::ls15_components::models::loot_survivor::FreeGameAvailableModelValue` struct
export interface FreeGameAvailableModelValue {
	fieldOrder: string[];
	available: boolean;
}
export type InputFreeGameAvailableModelValue = RemoveFieldOrder<FreeGameAvailableModelValue>;
...
// Type definition for `tournament::ls15_components::models::tournament::FreeGameTokenType` enum
