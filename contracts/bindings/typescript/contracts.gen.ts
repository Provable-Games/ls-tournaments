...
export async function setupWorld(provider: DojoProvider) {
	...
	const loot_survivor_mock_setAdventurerMeta = async (snAccount: Account | AccountInterface, adventurerId: BigNumberish, adventurerMeta: models.InputAdventurerMetadataStorage) => {
		try {
			return await provider.execute(
				snAccount,
				{
	...
	const LSTournament_createTournament = async (snAccount: Account | AccountInterface, name: BigNumberish, description: string, registrationStartTime: BigNumberish, registrationEndTime: BigNumberish, startTime: BigNumberish, endTime: BigNumberish, submissionPeriod: BigNumberish, winnersCount: BigNumberish, gatedType: models.CairoOption<GatedType>, entryPremium: models.CairoOption<GatedType>) => {
		try {
			return await provider.execute(
				snAccount,
				{
	...
	const LSTournament_startTournament = async (snAccount: Account | AccountInterface, tournamentId: BigNumberish, startAll: boolean, startCount: models.CairoOption<GatedType>, clientRewardAddress: string, goldenTokenFreeGameTokenIds: Array<BigNumberish>, blobertFreeGameTokenIds: Array<BigNumberish>) => {
		try {
			return await provider.execute(
				snAccount,
				{
					...
					calldata: [tournamentId, startAll, startCount, clientRewardAddress, goldenTokenFreeGameTokenIds, blobertFreeGameTokenIds],
				},
				"tournament",
			);
		} catch (error) {
	...
	const tournament_mock_startTournament = async (snAccount: Account | AccountInterface, tournamentId: BigNumberish, startAll: boolean, startCount: models.CairoOption<GatedType>, clientRewardAddress: string, goldenTokenFreeGameTokenIds: Array<BigNumberish>, blobertFreeGameTokenIds: Array<BigNumberish>) => {
		try {
			return await provider.execute(
				snAccount,
				{
